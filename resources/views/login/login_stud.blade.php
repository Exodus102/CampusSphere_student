...
<head>
    ...
    <!-- <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/campus_logo.png') }}"> -->
    ...
    <div class="login-container">
        ...
        <form method="POST" action="">
            ...
            <div class="register-link">
                First Time Login? <a href="{{ route('login.first_time') }}">Get Your Account Here</a>
            </div>
        </form>
    ...
    <div class="hero-container">
        <div class="hero-content">
            ...
            <div class="hero-slide">
                ...
                <p>
                    Keep track of announcements, collaborate with your organization, and communicate seamlessly within
                    CampusSphere.
                </p>
            </div>
